...
<body>
    ...
    <div class="container-fluid mb-5">
    	<div class="row">
    		<div class="card-columns">
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/41.JPG" alt="Card image">
    				<div class="overlay">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/42.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/43.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/44.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/45.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
		...
		<p>Kamu di Page ke 9</p>
        <li><a href="profil_Myalbum_users7.php">Halaman Sebelumnya</a>
		<li><a href="profil_Myalbum_users5.php">6</a><br>
		<li><a href="profil_Myalbum_users6.php">7</a><br>
		<li><a href="profil_Myalbum_users7.php">8</a><br>
		<li><a href="profil_Myalbum_users8.php">9</a><br>
		<li><a href="profil_Myalbum_users9.php">10</a><br>
		<li><a href="profil_Myalbum_users9.php">Halaman Selanjutnya</a>
