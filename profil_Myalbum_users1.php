    ...
    <div class="container-fluid mb-5">
    	<div class="row">
    		<div class="card-columns">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/9.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/10.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
		...
		<p>Kamu di Page ke 2</p>
        <li><a href="profil_Myalbum_users.php">Halaman Sebelumnya</a>
		...
		<li><a href="profil_Myalbum_users2.php">Halaman Selanjutnya</a>
