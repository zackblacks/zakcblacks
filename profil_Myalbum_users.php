...
<body>
    ...
    <div class="container mb-4">
    	...
    	<p>
    		Semoga harimu menyenangkan dengan Kami
    	</p>
    </div>
    <div class="container-fluid mb-5">
    	<div class="row">
    		<div class="card-columns">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/4.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/5.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
		...
		<li><a href="profil_Myalbum_users1.php">Halaman Selanjutnya</a>
