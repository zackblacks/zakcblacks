...
<body>
    ...
    <div class="container-fluid mb-5">
    	<div class="row">
    		<div class="card-columns">
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/26.JPG" alt="Card image">
    				<div class="overlay">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/27.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/28.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/29.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/30.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
		...
		<p>Kamu di Page ke 6</p>
        <li><a href="profil_Myalbum_users4.php">Halaman Sebelumnya</a>
		...
		<li><a href="profil_Myalbum_users6.php">Halaman Selanjutnya</a>
