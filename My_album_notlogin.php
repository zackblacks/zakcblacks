...
<body>
    ...
    <a class="navbar-brand font-weight-bolder mr-3" href="index.php"><img src="page_people/assets/img/20250115_060100.png"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarsDefault">
    	...
    	<ul class="navbar-nav ml-auto align-items-center">
    		...
    		<li class="nav-item">
    		<a class="nav-link" href="cek_login.php"><img class="rounded-circle mr-2" src="page_people/assets/img/av.png" width="30"><span class="align-middle">Login</span></a>
    		</li>
    	...
    	<div class="row">
    		...
    		<div class="collapse navbar-collapse" id="navbarsExplore">
    			<ul class="navbar-nav">
    				...
    				<li class="nav-item">
    				<a class="nav-link" href="login.php">Fikran smp</a>
    				</li>
    				<li class="nav-item">
    				<a class="nav-link" href="login.php">Angga smp</a>
    				</li>
    				<li class="nav-item">
    				<a class="nav-link" href="login.php">Adit adek</a>
    				</li>
    				<li class="nav-item">
    				<a class="nav-link" href="login.php">Damar smp</a>
    				</li>
    				<li class="nav-item dropdown">
    				<a class="nav-link dropdown-toggle" href="login.php" id="dropdown01" data-toggle="login.php" aria-haspopup="true" aria-expanded="false">More</a>
	...
	<div id="popup">
		<div class="window">
			...
			<h1>Disclaimer!</h1>
			<p>Foto yang ada disini berarti ada zakky nya, ini murni dari galeri Hp Zakky yang 100% di take pake kamera hp zakky,<br>
    	...
    	<div class="row">
    		<div class="card-columns">
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/10.JPG" alt="Card image">
    				<div class="overlay">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/13.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/8.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/17.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/23.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/21.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/12.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/20.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/19.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/14.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/16.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/9.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/4.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/7.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/5.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/18.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/3.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/2.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/1.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/zakky/15.jpg" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Cool Title</h2>
    					<div class="more">
