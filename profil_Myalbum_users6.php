...
<body>
    ...
    <div class="container-fluid mb-5">
    	<div class="row">
    		<div class="card-columns">
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/31.JPG" alt="Card image">
    				<div class="overlay">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/32.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/33.JPG" alt="Card image">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/34.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
    			...
    			<div class="card card-pin">
    				<img class="card-img" src="page_people/<?=$_SESSION['username']?>/35.JPG">
    				<div class="overlay">
    					<h2 class="card-title title">Some Title</h2>
    					<div class="more">
    						<a href="post.html">
		...
		<p>Kamu di Page ke 7</p>
        <li><a href="profil_Myalbum_users5.php">Halaman Sebelumnya</a>
		...
		<li><a href="profil_Myalbum_users7.php">Halaman Selanjutnya</a>
