      ...
      <header>
        <nav class="navbar">
          ...
          <div class="nav-section nav-right">
            ...
            <img src="page_people/assets/img/<?=$_SESSION['username']?>.jpg" alt="User Image" class="user-image" />
          </div>
        </nav>
      </header>
      ...
      <main class="main-layout">
        ...
        <aside class="sidebar">
          <div class="nav-section nav-left">
            ...
            <a href="#" class="nav-logo">
              <img src="page_people/assets/img/<?=$_SESSION['username']?>.jpg" alt="Logo" class="logo-image" />
              <h2 class="logo-text"><?=$_SESSION['username']?></h2>
            </a>
          </div>

          <div class="links-container">
            <div class="link-section">
              <a href="dashboard.php" class="link-item"> <i class="uil uil-estate"></i> Home </a>
